Template.vernHousingItemPage.helpers({
   vernhousingratings: function() {
   	var selectedHousingId = this._id;

   	var selectedHousing = VernHousings.findOne( {_id: selectedHousingId});
...
Template.vernHousingItemPage.events({
